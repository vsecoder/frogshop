        ...
        <>
            <header className="flex gap-5 justify-between w-full whitespace-nowrap max-w-[1240px] max-md:flex-wrap max-md:max-w-full m-auto p-5 pb-0">
                ...
                <div className="flex gap-5 justify-center my-auto text-base font-semibold max-md:flex-wrap">
                    <div className="hidden md:flex gap-2.5 justify-center px-20 py-2.5 my-auto rounded-3xl border border-solid border-neutral-900 text-neutral-900 max-md:px-5">
                        <img
                            loading="lazy"
                            src="/icons/find.svg"
                            alt="Search icon"
            ...
            <div className="p-5 pt-2 pb-0">
                <div className="flex md:hidden gap-2.5 justify-center px-20 py-2.5 my-auto rounded-3xl border border-solid border-neutral-900 text-neutral-900 pr-20 pb-1.5 pl-10 mt-0 max-w-full w-[1240px] max-md:px-5 m-auto">
                    <img
                        loading="lazy"
                        src="/icons/find.svg"
                        alt="Search icon"
