...
const ColorButton: React.FC<ColorButtonProps> = ({ color, children }) => {
  return (
    <div
      className={`justify-center px-4 py-2.5 rounded-md ${
        color === "black" ? "bg-stone-950" : "bg-blue-600"
  ...
  return (
    <div className="p-5 pt-0">
        ...
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            ...
            <div className="shrink-0 mx-auto max-w-full bg-blue-600 border border-blue-600 border-solid h-[379px] rounded-[30px] w-[559px]" />
            </div>
            ...
            <div className="flex flex-col mt-8 p-6 md:p-4 text-xs font-medium text-stone-950 max-md:mt-10 max-md:max-w-full">
                <h1 className="text-3xl max-md:max-w-full">{name}</h1>
